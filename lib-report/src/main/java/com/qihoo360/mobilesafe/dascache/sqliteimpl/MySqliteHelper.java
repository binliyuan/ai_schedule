 ...
 *
 * <p>You create a subclass implementing {@link #onCreate}, {@link #onUpgrade} and optionally {@link
 * #onOpen}, and this class takes care of opening the database if it exists, creating it if it does
 * not, and upgrading it as necessary. Transactions are used to make sure the database is always in
 * a sensible state.
 *
 ...
 *
 * <p>For an example, see the NotePadProvider class in the NotePad sample application, in the
 ...
 */
public abstract class MySqliteHelper {
     ...
     * actually created or opened until one of
     *
     * <p>Accepts input param: a concrete instance of {@link DatabaseErrorHandler} to be used to
     * handle corruption when sqlite reports database corruption.
     *
     * @param context to use to open or create the database
     * @param name of the database file, or null for an in-memory database
     * @param factory to use for creating cursor objects, or null for the default
     ...
     * is called, the database will be opened and {@link #onCreate}, {@link #onUpgrade} and/or
     * {@link #onOpen} will be called.
     *
     ...
     *
     * <p class="caution">Database upgrade may take a long time, you should not call this method
     * from the application main thread, including from {@link
     ...
     *
     * <p>This method is called before {@link #onCreate}, {@link #onUpgrade}, {@link #onDowngrade},
     * or {@link #onOpen} are called. It should not modify the database except to configure the
     * database connection as required.
     *
     * <p>This method should only call methods that configure the parameters of the database
     * connection, such as {@link SQLiteDatabase#enableWriteAheadLogging} {@link
     * SQLiteDatabase#setForeignKeyConstraintsEnabled}, {@link SQLiteDatabase#setLocale}, {@link
     ...
     *
     * <p>The SQLite ALTER TABLE documentation can be found <a
    ...
    /**
     * Called when the database needs to be downgraded. This is strictly similar to {@link
     ...
     *
     * <p>This method is called after the database connection has been configured and after the
     ...
     * downgraded, do it in {@link #onConfigure} instead.
     *
     * @param db The database.
     */
